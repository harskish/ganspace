...
def ganspace_view(request, model_name):
    ...
    if request.method == 'POST' and request.is_ajax():
        ...
        elif (response_type == 'save_component'):
            component_number = request.POST.get('component_number')
            component_name = request.POST.get('component_name')
            save_component(layer_start, layer_end, component_number, component_name)
